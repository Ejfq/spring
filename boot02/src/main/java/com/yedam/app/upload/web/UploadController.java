...
public class UploadController {
	...
	public void formUploadPage() { //void -> 경로를 파일명으로 쓰려고
		
	}
	
	@PostMapping("uploadForm")
	public String formUploadFile(@RequestPart MultipartFile[] images) { //input name속성 같아야함
		log.info(uploadPath);
